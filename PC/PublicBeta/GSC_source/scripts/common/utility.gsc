// scripts\common\utility.gsc  (692B19B8E5F8F9E8.gscc) (size: 55443 Bytes / 0xd893 / GSC)
// magic .... 0xa0d4353478a vm: Call of Duty: Modern Warfare III (PC)
// crc: 0x1207a89b (302491803)
// size ...... 55443 (0xd893)
// includes .. 12  (offset: 0x103e)
// strings ... 236 (offset: 0xc6db)
// dev strs .. 45  (offset: 0xd65b)
// exports ... 170 (offset: 0x82d3)
// cseg ...... 0x109e + 0x7235 (0x82d3)
// imports ... 298 (offset: 0x9d63)
// animtree1 . 0   (offset: 0xd893)
// animtree2 . 0   (offset: 0xd893)
...
function letterbox_enable(bool, time) {
    ...
    if (bool) {
        if (issp()) {
            setsaveddvar(@"hash_551829b57fe2b8f6", 1);
        } else {
            setdvar(@"hash_551829b57fe2b8f6", 1);
        }
