// scripts\common\debug.gsc  (77C18CDEDEC620B3.gscc) (size: 9040 Bytes / 0x2350 / GSC)
// magic .... 0xa0d4353478a vm: Call of Duty: Modern Warfare III (PC)
// crc: 0x1c962fc6 (479604678)
// size ...... 9040 (0x2350)
// includes .. 1   (offset: 0x72)
// strings ... 3   (offset: 0x2070)
// dev strs .. 48  (offset: 0x2098)
// exports ... 19  (offset: 0x1780)
// cseg ...... 0x7a + 0x1706 (0x1780)
// imports ... 44  (offset: 0x1a78)
// animtree1 . 0   (offset: 0x2350)
// animtree2 . 0   (offset: 0x2350)
...
/#
    ...
    function function_64f6fe11a0db2eef(x, y, scale) {
        ...
        if (!isdefined(scale)) {
            scale = getdvarfloat(@"scr_debug_print_scale", 0.8);
        }
        while (true) {
            waittillframeend();
