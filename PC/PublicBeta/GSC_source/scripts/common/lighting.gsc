// scripts\common\lighting.gsc  (4A2EE8C6E0EBF192.gscc) (size: 36760 Bytes / 0x8f98 / GSC)
// magic .... 0xa0d4353478a vm: Call of Duty: Modern Warfare III (PC)
// crc: 0xea8921b8 (3934855608)
// size ...... 36760 (0x8f98)
// includes .. 6   (offset: 0x60c)
// strings ... 91  (offset: 0x8704)
// dev strs .. 34  (offset: 0x8db8)
// exports ... 93  (offset: 0x61e8)
// cseg ...... 0x63c + 0x5bac (0x61e8)
// imports ... 147 (offset: 0x7070)
// animtree1 . 0   (offset: 0x8f98)
// animtree2 . 0   (offset: 0x8f98)
...
function lerp_spot_intensity_manage(ent, time, endintensity, flickerpercentage) {
    ...
    if (time <= 0) {
        if (!isdefined(level.var_f86dca03b4e10a79) || !level.var_f86dca03b4e10a79) {
            ent dontinterpolate();
        }
    }
...
// Size: 0x61b
function function_b01bc37bb97ec069(targetname, var_595f214a0c836320, min_intensity, max_intensity, fxid1, fxid2, var_7a699ba6660f6247, var_73423fd4b925b5f1, var_e40d0e4f030018db, var_75289c46941c448d, ender, snd_params, offint) {
    assert(isstring(targetname));
    self endon("death");
    if (isdefined(ender)) {
        level endon(ender);
