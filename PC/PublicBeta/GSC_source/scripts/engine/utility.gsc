// scripts\engine\utility.gsc  (4A55403D502E794F.gscc) (size: 122698 Bytes / 0x1df4a / GSC)
// magic .... 0xa0d4353478a vm: Call of Duty: Modern Warfare III (PC)
// crc: 0x517eb321 (1367257889)
// size ...... 122698 (0x1df4a)
// includes .. 6   (offset: 0x17d1)
// strings ... 188 (offset: 0x1cdfe)
// dev strs .. 35  (offset: 0x1dd62)
// exports ... 504 (offset: 0x1425a)
// cseg ...... 0x1801 + 0x12a59 (0x1425a)
// imports ... 370 (offset: 0x1911a)
// animtree1 . 0   (offset: 0x1df4a)
// animtree2 . 0   (offset: 0x1df4a)
    ...
    /#
        ...
        for (i = 0; i < params.size; i++) {
            if (i % 2 == 0 && isdefined(params[i]) && !isent(params[i]) && !isstruct(params[i])) {
                assertmsg("<dev string:x251>" + i + 1 + "<dev string:x286>" + i / 2 + 1 + "<dev string:x28c>");
            }
            if (i % 2 == 1 && isdefined(params[i]) && !isstring(params[i])) {
                assertmsg("<dev string:x251>" + i + 1 + "<dev string:x2ce>" + (i + 1) / 2 + "<dev string:x2d7>");
            }
        }
    #/
    struct = spawnstruct();
    ...
    /#
        ...
        for (i = 1; i < params.size; i++) {
            if (i % 2 == 1 && isdefined(params[i]) && !isent(params[i])) {
                assertmsg("<dev string:x251>" + i + 1 + "<dev string:x286>" + (i + 1) / 2 + "<dev string:x31d>");
            }
            if (i % 2 == 0 && isdefined(params[i]) && !isstring(params[i])) {
                assertmsg("<dev string:x251>" + i + 1 + "<dev string:x2ce>" + i / 2 + "<dev string:x361>");
            }
        }
    #/
    struct = spawnstruct();
