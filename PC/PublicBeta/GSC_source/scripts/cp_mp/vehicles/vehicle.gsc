// scripts\cp_mp\vehicles\vehicle.gsc  (7584507A08593DFE.gscc) (size: 49266 Bytes / 0xc072 / GSC)
// magic .... 0xa0d4353478a vm: Call of Duty: Modern Warfare III (PC)
// crc: 0xe47ae283 (3833258627)
// size ...... 49266 (0xc072)
// includes .. 34  (offset: 0x92d)
// strings ... 136 (offset: 0xb67a)
// dev strs .. 33  (offset: 0xbed2)
// exports ... 103 (offset: 0x78c2)
// cseg ...... 0xa3d + 0x6e85 (0x78c2)
// imports ... 368 (offset: 0x88da)
// animtree1 . 0   (offset: 0xc072)
// animtree2 . 0   (offset: 0xc072)
...
function private function_2ae5eae26e26efe9(vehicleref) {
    ...
    foreach (var_bafa22fcdefff511 in data.damageableparts) {
        ...
        case #"hash_6ade103971ce6e2c":
            ...
            break;
        default:
            var_bafa22fcdefff511.wheelref = undefined;
            break;
        }
        if (isdefined(var_bafa22fcdefff511.doorref) && var_bafa22fcdefff511.doorref == "not_a_door") {
            var_bafa22fcdefff511.doorref = undefined;
        } else {
            data.occupancy.hasdoors = 1;
        }
        if (isdefined(var_bafa22fcdefff511.windowref) && var_bafa22fcdefff511.windowref != "not_a_window" && var_bafa22fcdefff511.windowref != "generic_window") {
            seatref = removesubstr(var_bafa22fcdefff511.windowref, "_window");
        ...
        if (var_bafa22fcdefff511.windowref == "not_a_window") {
            var_bafa22fcdefff511.windowref = undefined;
        }
...
function function_fffe750fce66784(vehicleref, spawndata, faildata, fallbackvehicletype, donotwatchabandoned, mtx) {
    ...
    if (isdefined(mtx)) {
        husk.mtx = mtx;
        if (isdefined(mtx.var_c3606975ab404c5c)) {
...
function vehicle_deletenextframelate(vehicle) {
    ...
    scripts\cp_mp\vehicles\vehicle_spawn::function_2ddfaa43e6e40095(vehicle.vehiclename, vehicle getentitynumber());
...
function function_4201160d49c885a7(vehicle, mtx) {
    ...
    if (isdefined(mtx.turretcamo)) {
        foreach (turret in vehicle_getturrets(vehicle)) {
