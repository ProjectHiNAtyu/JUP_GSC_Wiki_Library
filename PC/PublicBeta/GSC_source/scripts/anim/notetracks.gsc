// scripts\anim\notetracks.gsc  (357B9A54DFEDBD4A.gscc) (size: 29441 Bytes / 0x7301 / GSC)
// magic .... 0xa0d4353478a vm: Call of Duty: Modern Warfare III (PC)
// crc: 0x371b241c (924525596)
// size ...... 29441 (0x7301)
// includes .. 7   (offset: 0x88a)
// strings ... 146 (offset: 0x69a9)
// dev strs .. 25  (offset: 0x7189)
// exports ... 84  (offset: 0x4365)
// cseg ...... 0x8c2 + 0x3aa3 (0x4365)
// imports ... 196 (offset: 0x5085)
// animtree1 . 0   (offset: 0x7301)
// animtree2 . 0   (offset: 0x7301)
...
function function_5a8f2c4ba78d7bff(note, flagname) {
    if (isai(self)) {
        ...
        self function_e99626add202fe1a(0, "script");
        if (utility::issp()) {
