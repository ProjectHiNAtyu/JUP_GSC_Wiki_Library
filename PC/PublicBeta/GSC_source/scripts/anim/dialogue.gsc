// scripts\anim\dialogue.gsc  (5D265B4FCA61F070.gscc) (size: 33428 Bytes / 0x8294 / GSC)
// magic .... 0xa0d4353478a vm: Call of Duty: Modern Warfare III (PC)
// crc: 0xf089aed2 (4035555026)
// size ...... 33428 (0x8294)
// includes .. 3   (offset: 0x80d)
// strings ... 97  (offset: 0x7bd8)
// dev strs .. 16  (offset: 0x81cc)
// exports ... 94  (offset: 0x56b0)
// cseg ...... 0x825 + 0x4e8b (0x56b0)
// imports ... 157 (offset: 0x6560)
// animtree1 . 0   (offset: 0x8294)
// animtree2 . 0   (offset: 0x8294)
...
function say(alias, priority, timeout, overlap, delay, scope) {
    ...
    if (is_dead_or_dying(speaker) || istrue(speaker.vo_disabled)) {
        return 0;
    }
...
function queue_say(speaker, alias, priority, timeout, overlap, delay) {
    ...
    if (!istrue(cancelled) && !is_dead_or_dying(speaker) && !istrue(speaker.vo_disabled)) {
...
function queue_sequence() {
    ...
    if (!istrue(cancelled) && !is_dead_or_dying(self.speaker) && !istrue(self.speaker.vo_disabled)) {
        execute_sequence();
    } else {
        self notify("proceeded");
    }
