// scripts\mp\mp_agent_damage.gsc  (7AF5DD2BC2CC926D.gscc) (size: 17654 Bytes / 0x44f6 / GSC)
// magic .... 0xa0d4353478a vm: Call of Duty: Modern Warfare III (PC)
// crc: 0xa3796984 (2742643076)
// size ...... 17654 (0x44f6)
// includes .. 28  (offset: 0x674)
// strings ... 105 (offset: 0x3ed6)
// dev strs .. 8   (offset: 0x4496)
// exports ... 19  (offset: 0x300a)
// cseg ...... 0x754 + 0x28b6 (0x300a)
// imports ... 93  (offset: 0x3302)
// animtree1 . 0   (offset: 0x44f6)
// animtree2 . 0   (offset: 0x44f6)
    ...
    if (isdefined(playerattacker)) {
        ...
        if (!istrue(level.disablestattracking)) {
            ...
            if (istrue(level.supportsai)) {
                thread scripts\cp_mp\challenges::function_5a0ae8bc2b80c0c0(einflictor, playerattacker, idamage, smeansofdeath, objweapon, shitloc, playerattacker.modifiers);
            }
